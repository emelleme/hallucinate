...
export const videoTracks: Record<VideoZone, string> = {
  ...
  outside: 'HIn1BxT38mE', // '0oB97YhEukw', // 'mqz9HpVNSAQ', // '5lthiQoQiRA', // 'ZEaqqk8V1bY', // 'CU0wjRIL1AQ', // '5aqWdYBG_js', //  'mqz9HpVNSAQ', // 'JviNPyhY6U4', // 'DK5XBwLiWZY', // 'xda6KAXJESo', // 'IIbcGjZy6OM', // '5lthiQoQiRA', 'CsGauHXioos', // 'HIn1BxT38mE', // , //
  tent: 'fz6nN5AtcYk',
}
